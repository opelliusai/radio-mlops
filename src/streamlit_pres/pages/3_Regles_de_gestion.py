...
st.write("- Model Drift")
st.write("Suivi de l'évaluation moyenne du recall entre les données de référence et les données de production")
st.subheader("- Drift monitoring - Seuils de drift")
st.write("Moyenne: 0.01")
st.write("Ecart type: 0.05")
st.write("Seuil Diff Recall: 0.05")
st.write("Ces valeurs sont définies dans le fichier de configuration et peuvent être modifiées")
